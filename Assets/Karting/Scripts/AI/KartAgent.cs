...
#region Training Modes
        ...
        [Tooltip("How difficult is the Agent?")]
        public AgentDifficult DifficultLevel = AgentDifficult.Easy;
...
#region Debugging
        ...
        void Awake()
        {
            ...
            {
                case AgentDifficult.Easy:
                    kart.baseStats.TopSpeed = 5f;
                    break;
                case AgentDifficult.Medium:
                    kart.baseStats.TopSpeed = 7.5f;
                    break;
                case AgentDifficult.Hard:
                    kart.baseStats.TopSpeed = 10f;
                    break;
            }
        }
